...
#ifndef AY_OBFUSCATE_DEFAULT_KEY_2V
// Second default key for OBFUSCATE2V
#define AY_OBFUSCATE_DEFAULT_KEY_2V ay::generate_key(__LINE__ * 2 + 1)
#endif
...
// Second version of obfuscation with a different default key
#define OBFUSCATE2V(data) OBFUSCATE_KEY(data, AY_OBFUSCATE_DEFAULT_KEY_2V)
