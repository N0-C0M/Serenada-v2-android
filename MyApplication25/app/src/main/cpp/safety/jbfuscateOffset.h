...
#ifndef REE_V3_JBFUSCATEOFFSET_H
#define REE_V3_JBFUSCATEOFFSET_H

#endif //REE_V3_JBFUSCATEOFFSET_H
...
namespace ay
{
    ...
    constexpr key_type generate_key(key_type seed)
    {
        ...
        key_type key = seed;
        key ^= (key >> 33);
        key *= 0xff51afd7558ccd;
        key ^= (key >> 33);
        key *= 0xc4ceb9fe3785ec53;
        key ^= (key >> 33);
...
#define OBFUSCATEOFFSET(data) OBFUSCATEOFFSET_KEY(data, AY_OBFUSCATE_DEFAULT_KEY)
...
#define OBFUSCATEOFFSET_KEY(data, key) \
